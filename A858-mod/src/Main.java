...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Arrays.toString(decrypted) + " " + decryptedString + " " + Arrays.toString(decrypted));
    }
